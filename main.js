...
//     <div class="container">
//       <a href="index.html" class="navbar-brand">Chief's Coffee Club</a>
...
//             <div class="card text-center">
//               <div class="card-header bg-dark text-white">
//                 <h3>Senior Chief Service Plan</h3>
//               </div>
//               <div class="card-body">
...
//             <div class="card text-center">
//               <div class="card-header bg-dark text-white">
//                 <h3>Master Chief Service Plan</h3>
//               </div>
//               <div class="card-body">
...
//         <div class="col">
//           <p>Copyright &copy;
//             <span id="year"></span> Chief's Coffee Club</p>
//         </div>
//       </div>
//     </div>
//   </footer>
...
function renderCoffee(coffee) {
    ...
    html += '<ul>';
    html += '<li>' +
                '<h1 class="d-inline">' + coffee.name + '</h1>' + '   ' +
                '<em><p class="d-inline">' + coffee.roast + '</p></em>' +
            '</li>';
    html += '</ul>';
    html += '</div>';
...
function updateCoffees(e) {
    ...
    //var coffeeName = coffeeInput.value.toLowerCase();
    var filteredCoffees = [];
